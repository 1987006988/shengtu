...
| `MQ-ACT1-02A《鹿门的价钱》` | `CH02-S01–S03` | 让玩家看见病床、配给、工分和安置排序怎样决定今天谁先活 | 完成医棚协助、账本分账、劳作换取临时停留 | 鹿门集靠延后名单与配额苟活；柳照禾是地方现实锚点 | 不得把共保会写成纯温情组织或把配额压力写空 |
...
| `PILOT-CH02-REGISTERED` | 医棚与账本室段落完成 | 锁定鹿门集的人命账、配额账与停留条件 |
