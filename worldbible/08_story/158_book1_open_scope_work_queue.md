# 158 Book1 Open Scope Work Queue

## 1. Queue Rules

- One wave at a time.
- No second truth chain.
- `79 / 80 / 96 / 97` remain evidence-chain assets, not production assets.
- Anything that changes the meaning of `15 / 16 / 21 / 22 / 54 / 55 / 56 / 57 / 58` must go through `159`.
...
1. `V1` production pass.
2. `V2` production pass.
3. `V3` production pass.
4. `SQ-SCOPE-01` formalization.
5. `SQ-SCOPE-02` formalization.
6. `Book1` open-scope production review.
