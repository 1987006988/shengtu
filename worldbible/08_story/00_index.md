...
- `59–61`：`Act I / CH01–CH02` 的最小任务化试点样本，只服务最小主线、最小 `Journal / Codex` 与首轮复盘。
- `62–64`：极小扩容评估与直线正文试点样本，只服务支线范围定义与 `CH01-S01–S02` 正文护栏验证，不等于主线正文或支线正文已开放。
- `65–72`：`A1 / CH01–CH03` 的主线正文闭环与门槛复盘，只服务 `72 PASS -> 才允许开 A1 主线任务层`。
- `73–81`：`A1` 主线任务层、`SQ-SCOPE-01` 单条支线试点与总集成复盘；通过后只表示 `Act I 任务层开放`，不表示全面任务层开放。
...
- 在当前阶段，只允许继续在 `A1 / CH01–CH03` 主线任务层与 `SQ-SCOPE-01` 单条支线试点的范围内推进；不默认进入 `CH04+`、更多支线或全面任务层
